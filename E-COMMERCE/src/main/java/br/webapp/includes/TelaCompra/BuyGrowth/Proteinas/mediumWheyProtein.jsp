 <div id="containerPai">
        <div class="itemFilho">
            <h1>MEDIUM WHEY PROTEIN<br> DA <br> GROWTH</h1>
            <h3>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet vitae ab, dolores nostrum ut, eveniet, perfer</h3>
        </div>

        <div class="itemFilho">
          <img src="${pageContext.request.contextPath}/imagens/Growth/imgProteinas/mediumWheyProtein.webp"
        ...
        <div class="itemFilho">
            <div class="itemNeto">
                ...
                <p class="preco" data-preco="126">126,00 R$</p> <br>
                <p id="erro"></p>
    ...
    <h2 class = "t2Compra">DESCRIÇÃO SOBRE O PRODUTO</h2>
 	...
 	<img src="${pageContext.request.contextPath}/imagens/Growth/tabelaNutricional/mediumWheyProtein.png"
