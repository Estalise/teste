 <div id="containerPai">
        <div class="itemFilho">
            <h1>CREATINA 100g  <br> DA <br> GROWTH</h1>
            <h3>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet vitae ab, dolores nostrum ut, eveniet, perfer</h3>
        </div>

        <div class="itemFilho">
          <img src="${pageContext.request.contextPath}/imagens/Growth/imgCreatinas/creatina100g.webp"
        ...
        <div class="itemFilho">
            <div class="itemNeto">
                ...
                <p class="preco" data-preco="150">150,00 R$</p> <br>
                <p id="erro"></p>
    ...
    <h2 class = "t2Compra">DESCRIÇÃO SOBRE O PRODUTO</h2>
 	...
 	<img src="${pageContext.request.contextPath}/imagens/Growth/tabelaNutricional/creatina100g.png"
